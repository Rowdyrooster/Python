...
class Application(Frame):
    ### AGUI Application with 3 buttons
        ...
        def create_widgets(self):
            ...
            self.exit = root.destroy
            self.forgot_button = self.newwin
            ...
            self.cancel_button = Button(self, text = "cancel", command = self.exit)
            self.cancel_button.grid(row = 7, column = 0, sticky = W)

            self.forgot_button = Button(self, text = "Forgot Password", command = self.newwin)
